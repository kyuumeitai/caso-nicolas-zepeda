const data = {
  title: `Misterio en la Habitación 106:
  Las huellas de Nicolás Zepeda
  `,
  description: `Hace cinco años, la estudiante japonesa Narumi Kurosaki desapareció en Besanzón, Francia. Todos los indicios seguidos por las autoridades locales apuntaban a la responsabilidad de su ex pareja, Nicolás Zepeda Contreras. La investigación reveló un tormentoso romance, la posesiva personalidad del joven chileno y sus sospechosos movimientos por Europa. Aquí presentamos, en 10 capítulos, las claves de un caso criminal que conmocionó a tres países.
  `,
  chapters: [
    {
      title: 'El acusado',
      ...
      La solitaria rutina que Nicolás Zepeda llevaba en la cárcel se rompió el 29 de marzo. Esa mañana salió de su celda en el centro de detención de La Butte y fue acompañado por los gendarmes a la van que lo trasladaría hasta el Palacio de Justicia de Besanzón. El vehículo fue escoltado por policías motorizados y llegó a las 8, dos horas antes del inicio de la audiencia.
      ...
      **Narrador:**
      ...
      Zepeda se fue a estudiar a Santiago en 2009, mientras que su familia dejó Temuco para iniciar un periplo por Antofagasta, La Serena y Viña del Mar. Su interés por la cultura japonesa lo llevó a postular a una beca para irse de intercambio a ese país. Fue ahí donde conoció a Narumi y fue ahí donde comenzó la historia que hoy lo tiene como presunto asesino.      
      `,
    },
    {
...
**Nicolás Zepeda:**Has destruido todo con tus mentiras. Haces de mí un tonto porque no estoy en Francia.

**Narumi Kurosaki:**No voy a aceptar que me llames mentirosa.

**Nicolás Zepeda:**Demuéstrame que eres seria, quiero ver tu compromiso. Decides defender a tres tipos que conociste la semana pasada. ¿Tú quieres que yo los contacte, les envíe un mensaje en Facebook diciendo que tú eres mi pareja para que dejen de andar detrás de ti?

**Narumi Kurosaki:**Nunca suprimiré a Rafa y Arthur. Hablamos más tarde.

**Nicolás Zepeda:**Voy a perder la paciencia, Narumi. Me has tratado como a un basurero.
...
**Narumi Kurosaki:**Jamás olvidaré que me preñaste, tú nunca te sentiste responsable de mi embarazo, de mi hijo.

**Nicolás Zepeda:**Recuerda, yo quería que verificáramos eso antes de que te fueras (…) Vine a Japón y tú te escapaste a Francia. Tú nos destruiste por razones egoístas.

****

**Narumi Kurosaki:**Vete a que te den por culo.
...
**Nicolás Zepeda:**Sufrí un choque cultural inverso.
    ...
    },
    {
      ...
      **Abogado Schwerdorffer**: ¡Así que el único_souvenir_ que se llevó de Dijon fue una caja de fósforos! ¡Y lo compró junto a un combustible!
...
**Nicolás Zepeda:** Nos despertamos a las 7 de la mañana. Vi que empezó a prepararse para salir, pero el tiempo estaba malo y prefirió quedarse conmigo en la piea. Tomamos desayuno y nos quedamos dormidos viendo una película. Entonces escuchamos que había gente tocando la puerta.
...
Cuando en el juicio le hicieron ver que las iglesias estaban cerradas a esa hora, Zepeda apuntó a un error de traducción al francés: en realidad había dicho que durmió “cerca de la iglesia”.
...
La esperanza de los investigadores es que los restos aparezcan tarde o temprano, como ocurrió en otro caso de alto perfil ocurrido en la zona: la desaparición de la pequeña Maelys de Araujo, de ocho años. El descubrimiento del cuerpo, sin embargo, solo se hizo gracias a la confesión del asesino. En el caso Narumi, ya sea porque no sabe o porque no quiere, Zepeda está lejos de dar esa información.  
    ...
    },
    {
      ...
      description: `Zepeda logró refugiarse en Chile antes de que la policía francesa exigiera su detención. Desde entonces, su vida quedó sujeta a los distintos procesos en su contra y en manos de juristas de alto perfil como Jacqueline Laffont, exdefensora de Nicholas Sarkozy.`,
      coordinates: {
        x: 0,
        y: 0,
      },
